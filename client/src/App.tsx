...
import OrdersPharmacy from "@/pages/orders/pharmacy";
import OrdersWholesale from "@/pages/orders/wholesale";
    ...
    <Switch>
      ...
      {isLoading || !isAuthenticated ? (
        ...
        <>
          ...
          <Route path="/orders/pharmacy" component={OrdersPharmacy} />
          <Route path="/orders/wholesale" component={OrdersWholesale} />
