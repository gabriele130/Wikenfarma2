...
import { Plus, UserCheck, Phone, Mail, MapPin, Share, Eye } from "lucide-react";
...
export default function Informatori() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: InformatoreFormData) =>
      apiRequest('/api/informatori', {
        method: 'POST',
    ...
    return (
      <Layout>
        <div className="flex items-center justify-center h-64">
          <div className="text-lg text-gray-600">Caricamento informatori...</div>
        </div>
      </Layout>
    );
  }
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Informatori Medici</h1>
            <p className="text-gray-600 mt-1">
              Gestisci gli informatori medici scientifici e le loro dashboard condivisibili
            </p>
          </div>
